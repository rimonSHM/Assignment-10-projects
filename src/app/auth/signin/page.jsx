...
import { Card, Button, Link, TextField, Label, InputGroup, Input } from "@heroui/react";
import { Eye, EyeSlash, At, ShieldKeyhole } from "@gravity-ui/icons";
// FIX 1: সঠিক রিলেটিভ পাথ ব্যবহার করে authClient ইম্পোর্ট করুন
...
export default function SigninPage() {
    ...
    const handleSignin = async (e) => {
        ...
        try {
            // FIX 2: signIn.email এর বদলে authClient.signIn.email ব্যবহার করুন
            // এবং সফল হলে রিডাইরেক্ট করার জন্য callbackURL সেট করুন "/home"
            ...
            // কোনো আসল নেটওয়ার্ক বা সার্ভার সমস্যা হলে এটি দেখাবে
            setError("An unexpected network error occurred.");
        } finally {
            setIsLoading(false);
        }
